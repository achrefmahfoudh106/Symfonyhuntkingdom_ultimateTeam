...
$c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver([($this->targetDirs[3].'\\src\\ForumBundle\\Resources\\config\\doctrine') => 'ForumBundle\\Entity', ($this->targetDirs[3].'\\src\\ProductBundle\\Resources\\config\\doctrine') => 'ProductBundle\\Entity']);
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'ForumBundle' => 'ForumBundle\\Entity', 'ProductBundle' => 'ProductBundle\\Entity']);
